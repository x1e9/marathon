...
class DeploymentModule(
    ...
    deploymentActorProps: (ActorRef, KillService, DeploymentPlan, InstanceTracker, LaunchQueue, HealthCheckManager, EventStream, ReadinessCheckExecutor, Metrics) => Props = DeploymentActor.props)(implicit val mat: Materializer) {
